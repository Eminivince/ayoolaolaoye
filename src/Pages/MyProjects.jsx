        ...
        <div className='md:relative'>
            <div className='md:flex w-[100%] hidden'>
                ...
                <div className='basis-1/2  text-right flex flex-col justify-between'>
                    ...
                    <div  >
                        <ul className='flex cust--font md:text-base text-xs space-x-2 text-green-300 justify-end'>
                            <li>Blockchain</li>
                            <li>Solidity</li>
            ...
            <div className='md:w-[55%] bg-slate-800 p-5 rounded md:text-right md:absolute md:top-24 md:left-[45%]'>
                <div>
                    ...
                    <div className='mb-8'>
                        <ul className='flex overflow-auto  cust--font md:text-base text-xs space-x-1 text-green-300 md:justify-end md:hidden'>
                            <li>Blockchain</li>
                            <li>Solidity</li>
                            <li>Smart Contract</li>
                            <li>React</li>
